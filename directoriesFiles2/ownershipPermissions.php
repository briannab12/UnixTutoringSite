	...
	<div class ="wrapper"> 
		...
		<div class ="content"> 
		   ...
		   <div class = "fullwidth" >
				...
				<p>
		   			<strong>Permissions of a file</strong>
				</p>
					<ul>
				...
				<p>
					<strong>Permissions of a Directory</strong>
				</p>
					<ul>
		   ...
		   <div class="seperator100"></div>
			<div class="button-container float-right">
				<div class="button purple">
					<a href="<?php echo $path;?>directoriesFiles2/changingPermissions.php">Next</a>
				</div>
			</div>
		</div>
