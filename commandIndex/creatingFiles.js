...
//Create File tutorial 2
function CreateFileTwo() 
{
	////////////////////// UPDATE ME //////////////////////
	// The correct answer
	var correct = "echo 'I love learning about unix \n' > ex1.txt";
	...
	if(inputVal == correct)
	{
		...
		////////////////////// UPDATE ME //////////////////////
		// The new image
		document.getElementById("CreateFileImage2").src = imgLoc + "assets/images/tutorial/directoriesFiles/Createfiles2.png";
	}
	else
	{
		// If the value is incorrect, prompts user to re-enter 
...
function CreateFileThree() 
{
	////////////////////// UPDATE ME //////////////////////
	// The correct answer
	var correct = "printf 'I love learning about unix \n. I can now create a text file in unix' > ex2.txt";
